  ...
  return (
    <div className="pt-24">
      ...
      <section className="max-w-3xl mx-auto px-6 py-16 md:py-24">
        ...
        <p className="text-xl text-body">Direct access, strategic thinking, and a system that delivers what usually takes a team.</p>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 py-12 border-t border-border">
        ...
        <div className="bg-peach border border-orange-100 rounded-xl p-6 md:p-8 mb-6">
          <p className="text-ink leading-relaxed mb-4">
            FirstLook's scoring engine didn't start sophisticated. The first version was a deliberately simple scoring model - enough to prove the concept worked. What turned it into something robust was iteration under pressure: I ran the approach across different AI platforms, each challenging it from a different angle, and used that to decide which signals actually separate genuine candidates from spray-and-pray applications.
          </p>
          <p className="text-ink leading-relaxed">
            That's how it became the multi-algorithm scoring system in v3.1 - not one clever idea, but a scoring model refined over time, with cross-platform pressure-testing catching weaknesses before users did.
          </p>
        </div>
